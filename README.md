...
exo starts a ChatGPT-like WebUI (powered by [tinygrad tinychat](https://github.com/tinygrad/tinygrad/tree/master/examples/tinychat)) on http://localhost:7860

For developers, exo also starts a ChatGPT-compatible API endpoint on http://localhost:7860/v1/chat/completions. Examples with curl:
