...
DEBUG_DISCOVERY=7 DEBUG=7 python3 main.py --node-id "node1" --listen-port 5678 --broadcast-port 5679 --chatgpt-api-port 7860 --chatgpt-api-response-timeout 900 > output1.log 2>&1 &
PID1=$!
